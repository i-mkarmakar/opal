...
const ContactHero = () => {
    return (
        <div className="relative z-0 w-full h-full">
            <div className="bg-brand-radial absolute -top-16 inset-x-0 -z-10 mx-auto h-32 w-3/4 rounded-full blur-[5rem] lg:h-60"></div>
                ...
                <div className="flex flex-col items-center justify-center w-full z-10">
                    ...
                    <Container delay={0.2}>
                        <p className="text-base md:text-lg font-normal text-center text-balance text-muted-foreground max-w-3xl mx-auto mt-4">
                            Questions about GitHub permissions, rules, or billing? Reach out—we’ll help you get Opal running the way your team works.
                        </p>
                    </Container>
